...
* On the *Your Translation Projects* screen the options menu includes the following options: 
  ...
  * **Settings**: Adjust translationStudio settings; view license agreement, statement of faith, or translation guidelines  (See *translationStudio for Android: Modifying Program Settings*)
