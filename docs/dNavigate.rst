...
* On the *Your Translation Projects* screen the options menu includes the following options: 
  ...
  * **Settings**: Adjust translationStudio settings; view license agreement, statement of faith, or translation guidelines  (See `Settings <ts-info.readthedocs.io/en/latest/dSettings.html>`_)
